...
report = Namespace('Report', description='Report operations', path='/user/')
...
@report.route('/user/<int:user_id>')
class get_one_report(Resource):
    @jwt_required
...
@report.route('/user/update/<int:user_id>')
